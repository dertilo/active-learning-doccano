...
def create_user(username,password,user_id=None,first_name='',last_name='',email=''):
...
def purge_project_documents(project_id):
    [delete_document(project_id=project_id,doc_id=d['id']) for d in list_documents(project_id)]
